...
export default function VendorSupportScreen() {
  ...
  useEffect(() => {
    ...
    supportService.getSupportTicket(detailTicketId).then(
      ...
      (e: any) => { if (!cancelled) setDetailError(e?.message || 'Failed to load ticket details.'); },
  ...
  const onDetailRefresh = useCallback(() => {
    ...
    supportService.getSupportTicket(detailTicketId).then(
      ...
      (e: any) => setDetailError(e?.message || 'Failed.'),
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Create Support Ticket Modal (drawer) */}
          ...
          <View style={styles.modalCard}>
            ...
            >
              ...
              <View style={styles.inputGroup}>
                ...
                <Text style={{ marginTop: 4, fontSize: 12, color: Colors.textSecondary, fontFamily: Typography.fontFamily.regular }}>
                  Automatically set based on your role.
                </Text>
              </View>
            </ScrollView>
                ...
                >
                  <View style={styles.detailCoreCard}>
                    ...
                    <View style={styles.detailCoreRow}>
                      ...
                      <Text style={styles.detailCoreValuePurple}>
                        {(detailData.targetRole ?? '—').charAt(0).toUpperCase() + (detailData.targetRole ?? '').slice(1)}
                      </Text>
                    </View>
                    <View style={styles.detailCoreRow}>
...
const styles = StyleSheet.create({
  ...
  // Tabs
  tabsRow: { flexDirection: 'row', paddingHorizontal: 16, paddingTop: 16, marginBottom: 4 },
  tabItem: { marginRight: 24 },
  tabLabel: { fontSize: 14, fontFamily: Typography.fontFamily.semiBold, color: Colors.textSecondary },
  ...
  cardId: { fontSize: 12, fontFamily: Typography.fontFamily.medium, color: Colors.textSecondary },
  statusBadge: { paddingHorizontal: 10, paddingVertical: 3, borderRadius: 10 },
  statusBadgeText: { fontSize: 11, fontFamily: Typography.fontFamily.bold, letterSpacing: 0.5 },
  cardTitle: {
    fontSize: 16,
  ...
  detailTicketIdLabel: { fontSize: 10, fontFamily: Typography.fontFamily.semiBold, color: Colors.textSecondary, letterSpacing: 1 },
  detailTicketIdValue: { fontSize: 12, fontFamily: Typography.fontFamily.regular, color: Colors.textSecondary },
  detailTitle: { fontSize: 20, fontFamily: Typography.fontFamily.bold, color: Colors.text, marginBottom: 12 },
  ...
  detailCoreLabel: { fontSize: 10, fontFamily: Typography.fontFamily.bold, color: Colors.textSecondary, letterSpacing: 1, marginBottom: 2 },
  detailCoreValueRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  detailCoreValue: { fontSize: 14, fontFamily: Typography.fontFamily.regular, color: Colors.text },
  detailCoreValuePurple: { fontSize: 14, fontFamily: Typography.fontFamily.semiBold, color: Colors.primary },
  ...
  detailAvatarText: { fontSize: 14, fontFamily: Typography.fontFamily.bold, color: Colors.primary },
  detailCreatedByInfo: { flex: 1 },
  detailCreatedByName: { fontSize: 14, fontFamily: Typography.fontFamily.semiBold, color: Colors.text },
  detailCreatedByEmail: { fontSize: 12, fontFamily: Typography.fontFamily.regular, color: Colors.textSecondary, marginTop: 2 },
  detailSectionLabel: { fontSize: 10, fontFamily: Typography.fontFamily.semiBold, color: Colors.textSecondary, letterSpacing: 1, marginBottom: 8 },
  ...
  detailDescriptionText: { fontSize: 14, fontFamily: Typography.fontFamily.regular, color: Colors.text, lineHeight: 20 },
  detailConversationHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 },
  detailConversationTitle: { fontSize: 16, fontFamily: Typography.fontFamily.bold, color: Colors.text },
  detailMessagesPill: { backgroundColor: '#E5E7EB', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 999 },
  detailMessagesPillText: { fontSize: 12, fontFamily: Typography.fontFamily.semiBold, color: Colors.textSecondary },
  ...
  detailConversationEmptyText: { marginTop: 8, fontSize: 14, fontFamily: Typography.fontFamily.regular, color: Colors.textSecondary },
});
