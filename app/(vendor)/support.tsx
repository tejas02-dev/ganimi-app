...
export default function VendorSupportScreen() {
  ...
  const loadList = useCallback(async () => {
    try {
      ...
      console.error('[VendorSupport] loadList', e);
  ...
  const handleCreateTicket = async () => {
    ...
    try {
      ...
      console.error('[VendorSupport] createTicket', e);
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Support requests you've received. Create a ticket for help or complaints.
          </Text>
        </View>
            ...
            >
              ...
              <View style={styles.inputGroup}>
                ...
                <Text style={styles.helperText}>
                  This is automatically set based on your role
                </Text>
              </View>
            </ScrollView>
